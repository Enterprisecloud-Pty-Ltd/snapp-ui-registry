  ...
  "group/button inline-flex cursor-pointer shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        "form-primary":
          "bg-snapp-button-primary text-snapp-text-invert shadow-none hover:brightness-90 hover:text-snapp-text-invert",
        "form-secondary":
          "border-snapp-card-border bg-popover text-foreground/50 shadow-none hover:bg-muted hover:text-foreground",
        "form-destructive":
          "bg-snapp-danger text-snapp-text-invert shadow-none hover:brightness-90 hover:text-snapp-text-invert",
        ghost:
          "hover:bg-muted hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:hover:bg-muted/50",
        overflow:
          "border-0 bg-transparent text-snapp-icon-primary hover:bg-snapp-grey-900/5 hover:text-snapp-icon-primary aria-expanded:bg-snapp-grey-900/5 aria-expanded:text-snapp-icon-primary",
        destructive:
      ...
      size: {
        ...
        icon: "size-8",
        overflow:
          "h-5 w-5.5 rounded-sm px-0.75 py-0.5 [&_svg:not([class*='size-'])]:size-4",
        form:
