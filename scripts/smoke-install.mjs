...
try {
	...
	await writeFile(
		...
		[
			...
			'import { CatalogueHero, CatalogueResultCard, FeatureBreadcrumb, FeatureShell, FilterChip, FilterMenuSurface, FilterTokenList, HelpArticleAccordion, LandingCard, LandingSkeleton, PageBody, SurfaceCard, matchesSearch, resolveShowNavBar } from "@/components/snapp/catalogue/catalogue-core"',
			...
			'            <DialogHeader size="form"><DialogTitle size="form">Edit item</DialogTitle></DialogHeader>',
			'            <DialogBody size="form"><Input aria-label="Dialog input" variant="form" /></DialogBody>',
			'            <DialogFooter size="form"><Button size="form" variant="form-secondary">Cancel</Button><Button size="form" variant="form-primary">Save</Button></DialogFooter>',
			"          </DialogContent>",
			"        </Dialog>",
			"        <DropdownMenu>",
			"          <DropdownMenuTrigger asChild>",
			'            <Button aria-label="More actions" size="overflow" variant="ghost"><EllipsisIcon /></Button>',
			"          </DropdownMenuTrigger>",
			'          <DropdownMenuContent size="quick-actions">',
			'            <DropdownMenuItem size="quick-actions">Edit</DropdownMenuItem>',
			'            <DropdownMenuItem size="quick-actions">Delete</DropdownMenuItem>',
			"          </DropdownMenuContent>",
			"        </DropdownMenu>",
			"        <ContextMenu>",
			'          <ContextMenuTrigger><div>Right-click for actions</div></ContextMenuTrigger>',
			'          <ContextMenuContent size="quick-actions">',
			'            <ContextMenuItem size="quick-actions">Configure</ContextMenuItem>',
			'            <ContextMenuItem size="quick-actions">Remove</ContextMenuItem>',
			"          </ContextMenuContent>",
			"        </ContextMenu>",
			"      </PageBody>",
			"    </FeatureShell>",
